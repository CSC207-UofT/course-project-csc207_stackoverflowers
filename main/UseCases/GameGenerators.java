...
public class GameGenerators implements Serializable {
    ...
    public void generateProjects(int proj) {
        ...
        Random random = new Random();
        projList.add(prompts.PROJECT1_NAME);
        projList.add(prompts.PROJECT2_NAME);
        projList.add(prompts.PROJECT3_NAME);
        projList.add(prompts.PROJECT4_NAME);
        projList.add(prompts.PROJECT5_NAME);
        projList.add(prompts.PROJECT6_NAME);
        projList.add(prompts.PROJECT7_NAME);
        projList.add(prompts.PROJECT8_NAME);
